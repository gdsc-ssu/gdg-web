...
import SeminarMainImg from "@public/ssumall seminar png.png";
...
const Seminar = () => {
  ...
  return (
    <main className="w-full min-h-screen bg-white pt-16">
      <section className="max-w-[1280px] mx-auto px-6 sm:px-4">
        <div className="text-center mb-12">
          <h1 className="text-[48px] sm:text-[36px] font-extrabold text-primary-red">
            SSUmall Seminar
          </h1>
          <p className="text-lg sm:text-base text-gray-700 mt-2 font-semibold">
        ...
        <main className="w-full min-h-screen bg-white py-16">
          <section className="max-w-[1280px] mx-auto px-6 sm:px-4 flex items-center justify-center">
            <div className="flex flex-row gap-8 sm:flex-row items-center sm:items-start space-y-6 sm:space-y-0 sm:space-x-8">
              ...
              <div className=" rounded-md p-6 shadow-sm relative w-[400px]">
